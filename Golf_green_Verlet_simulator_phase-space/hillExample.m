...
name='greenhillexample.png.tiff'
sanitizedname=[strrep(name,'.','') '_withpin']
...
%pin
holeLoc=[320;256];%size(greenheight)'/2;
holeRadius=6;
...
angles=(45)*pi/180;
speeds=400;
angles=linspace((0+8)*pi/180,(0-8)*pi/180,10);%-pi/4;
speeds=linspace(150,20,100);
angles=linspace((0+8)*pi/180,(0-8)*pi/180,20);%-pi/4;
speeds=linspace(150,20,100);
...
dists=((reshape(distToHole,length(angles),length(speeds))'));
