...
greenheight=fliplr(rot90(rot90(double(imread(name))/256*.15)));
greenheightPLOT=fliplr(rot90(rot90(double(imread(name))/256*.15)));
...
speeds=linspace(minSpeed,150,50);
