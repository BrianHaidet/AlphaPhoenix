...
greenheightPLOT=fliplr(rot90(rot90(double(imread(name))/256*.4)));
...
angles=linspace((45-90)*pi/180,(45+90)*pi/180,151);%-pi/4;
speeds=linspace(minSpeed,300,51);
