...
name='greencone.tiff'
sanitizedname=[strrep(name,'.','') '_static']
...
greenheight=fliplr(rot90(rot90(double(imread(name))/256*.3))).^.5 * 9;
greenheightPLOT=fliplr(rot90(rot90(double(imread(name))/256*.3))).^.5 * 9;
