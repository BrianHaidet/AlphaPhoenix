...
% saving frame files and backup runtime files when you atert the program,
% so be ready for that (actually it'l probably glitch out if you don't have
% the folders already, but still). It also needs "plotter.m' or
% "plotterFast.m" in the same MATALAB path folder to read said frame files 
% and output pictures.
