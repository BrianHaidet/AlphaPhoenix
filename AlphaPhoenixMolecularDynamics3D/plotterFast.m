...
function [] = plotterFast(iteration)
...
markerSize=1000
scatter3(r(1,1:2:end),r(2,1:2:end),r(3,1:2:end),markerSize,'MarkerEdgeColor', 'black', 'MarkerFaceColor', 'red');
hold on
scatter3(r(1,1+1:2:end-1),r(2,1+1:2:end-1),r(3,1+1:2:end-1),markerSize,'MarkerEdgeColor', 'black', 'MarkerFaceColor', 'blue');
hold off
